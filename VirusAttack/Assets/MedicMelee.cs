...
public class MedicMelee : MonoBehaviourPunCallbacks
{
    BoxCollider newcollider;
    PhotonView view;
    private MedicController _medicController;
    ...
    */
    ...
    IEnumerator waiter()
    {
        ...
        newcollider.size = new Vector3(1f, 2.464509f, 1.5f);
        yield return new WaitForSeconds(.90f);
        newcollider.size = new Vector3(1f, 2.464509f, 0.7947788f);
