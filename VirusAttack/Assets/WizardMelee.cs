...
public class WizardMelee : MonoBehaviourPunCallbacks
{
    ...
    IEnumerator waiter()
    {
      //  animator.SetBool("IsAttacking", true);
        ...
        newcollider.size = new Vector3(1f, 2.213724f, 2f);
        yield return new WaitForSeconds(.90f);
        newcollider.size = new Vector3(1f, 2.213724f, 0.8954754f);
